...
-- SCRIPT UNIFICADO (SCHEMA + SEED COMPLETO)
-- COMPATIBILIDAD: MySQL 5.7+, MySQL 8.0+, MariaDB 10.3+
-- =============================================================================
...
CREATE TABLE `veredas` (
  ...
  `distance_km_from_center` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `households_count` INT UNSIGNED NOT NULL DEFAULT 0,
  `population_estimate` INT UNSIGNED NOT NULL DEFAULT 0,
  `critical_points_count` INT UNSIGNED NOT NULL DEFAULT 0,
  `map_coord_x` INT NOT NULL DEFAULT 0,
  `map_coord_y` INT NOT NULL DEFAULT 0,
  `latitude` DECIMAL(10,6) NOT NULL DEFAULT 3.858000,
  `longitude` DECIMAL(10,6) NOT NULL DEFAULT -74.931000,
...
CREATE TABLE `users` (
  ...
  `vereda_id` VARCHAR(60) NULL,
  `phone` VARCHAR(30) NOT NULL,
  `role` ENUM('habitante', 'conductor', 'coordinador', 'administrador') NOT NULL DEFAULT 'habitante',
...
CREATE TABLE `trucks` (
  ...
  `year` SMALLINT UNSIGNED NOT NULL DEFAULT 2023,
  `capacity_tons` DECIMAL(5,2) NOT NULL DEFAULT 5.00,
  `current_load_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  ...
  `fuel_level_percent` TINYINT UNSIGNED NOT NULL DEFAULT 100,
  `current_vereda` VARCHAR(100) NULL,
  `service_zone` VARCHAR(80) NOT NULL DEFAULT 'General',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `rural_routes` (
  ...
  `vereda_id` VARCHAR(60) NOT NULL,
  `vereda_name` VARCHAR(100) NOT NULL,
  `scheduled_date` DATE NOT NULL,
  `start_time` VARCHAR(20) NOT NULL,
  `estimated_end_time` VARCHAR(20) NOT NULL,
  `truck_id` VARCHAR(60) NOT NULL,
  ...
  `estimated_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `collected_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `recycled_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  ...
  `notes` TEXT NULL,
  `incidents_reported` INT UNSIGNED NOT NULL DEFAULT 0,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `collection_records` (
  ...
  `truck_plate` VARCHAR(15) NOT NULL,
  `driver_name` VARCHAR(150) NOT NULL,
  `organic_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `plastic_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `glass_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `cardboard_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `metal_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `ordinary_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `total_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `recycled_tons` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `efficiency_percent` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE `incident_alerts` (
  ...
  `prevented_burning` TINYINT(1) NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------------------------------
-- 3. INSERCIÓN DE DATOS INICIALES (PURIFICACIÓN, TOLIMA)
-- -----------------------------------------------------------------------------
...
-- =============================================================================
-- FIN DEL SCRIPT: Base de datos `ecorural_purificacion` creada exitosamente
-- =============================================================================
